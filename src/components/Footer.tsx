      ...
      <div className="max-w-6xl mx-auto px-6 py-14">
        <div className="grid md:grid-cols-3 gap-10 mb-10">
          <div>
            ...
            <p className="text-xs leading-relaxed" style={{ color: 'rgba(244,241,237,0.30)' }}>
          ...
          <div>
            <p className="text-xs uppercase tracking-widest mb-5" style={{ color: 'rgba(138,21,53,0.60)', letterSpacing: '0.12em' }}>Navigation</p>
              ...
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="text-xs hover:opacity-70 transition-opacity"
                    style={{ color: 'rgba(244,241,237,0.35)', textDecoration: 'none', letterSpacing: '0.04em' }}>
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <p className="text-xs uppercase tracking-widest mb-5" style={{ color: 'rgba(138,21,53,0.60)', letterSpacing: '0.12em' }}>Coordonnées</p>
            <address style={{ fontStyle: 'normal' }} className="space-y-2">
              <p className="text-xs" style={{ color: 'rgba(244,241,237,0.35)' }}>2 Rue Buhan</p>
              <p className="text-xs" style={{ color: 'rgba(244,241,237,0.35)' }}>33000 Bordeaux</p>
              <a href="tel:+33699046862" className="block text-xs mt-3 hover:opacity-70 transition-opacity"
                style={{ color: 'rgba(244,241,237,0.35)', textDecoration: 'none' }}>
                06 99 04 68 62
              </a>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4"
          ...
          <p className="text-xs" style={{ color: 'rgba(244,241,237,0.18)', letterSpacing: '0.04em' }}>
            &copy; {new Date().getFullYear()} Maître Charlène Crochet. Tous droits réservés.
          </p>
          <p className="text-xs" style={{ color: 'rgba(244,241,237,0.15)' }}>
