      ...
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <blockquote className="mt-4">
          <p className="font-light leading-relaxed mb-10"
            style={{ fontFamily: 'var(--font-raleway)', fontSize: 'clamp(1rem, 1.8vw, 1.25rem)', color: 'rgba(244,241,237,0.80)', fontStyle: 'italic' }}>
          ...
          <footer>
            <div className="mx-auto" style={{ width: '32px', height: '1px', background: 'rgba(138,21,53,0.45)', marginBottom: '1rem' }} />
